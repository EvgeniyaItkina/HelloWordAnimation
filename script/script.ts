const helloWorldElements = [
    document.getElementById('hello-world1') as HTMLDivElement,
    document.getElementById('hello-world2') as HTMLDivElement,
...
function helloWorld(element: HTMLDivElement) {
